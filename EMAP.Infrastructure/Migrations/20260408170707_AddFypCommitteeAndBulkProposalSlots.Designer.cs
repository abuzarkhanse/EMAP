...
namespace EMAP.Infrastructure.Migrations
{
    ...
    [Migration("20260408170707_AddFypCommitteeAndBulkProposalSlots")]
    partial class AddFypCommitteeAndBulkProposalSlots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EMAP.Domain.Fyp.FypCommittee", b =>
                {
                    ...
                    b.Property<string>("ConvenorUserId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EMAP.Domain.Fyp.ProposalDefenseSchedule", b =>
                {
                    ...
                    b.Property<string>("BulkBatchKey")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<bool>("IsBulkAssigned")
                        .HasColumnType("bit");
